package com.tzs.antique.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://8.219.254.96:3306/hbook?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "xin1127";
    // @author 值
    private static final String AUTHOR = "YHS";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.tzs.hbook.book";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        String [] tableName = scanner("表名").split(",");// ‘,’分割多表
